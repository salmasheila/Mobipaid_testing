...
WebUI.setText(findTestObject('Object Repository/Page_Register/input_Login_signatory_first_name'), 'Salma')

WebUI.setText(findTestObject('Object Repository/Page_Register/input_Login_signatory_last_name'), 'Sheila Maulina')

WebUI.setText(findTestObject('Object Repository/Page_Register/input_Login_email'), 'salmasheilamp@gmail.c')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Register/input_Login_password'), 'ZLOfdpcruIo=')

WebUI.setText(findTestObject('Object Repository/Page_Register/input_Login_name'), 'PNL')

WebUI.setText(findTestObject('Object Repository/Page_Register/input_land Islands_form-control btn-log bor_48151b'), '81262417909')
...
WebUI.verifyElementPresent(findTestObject('Page_Register/input_Login_email'), 30)
